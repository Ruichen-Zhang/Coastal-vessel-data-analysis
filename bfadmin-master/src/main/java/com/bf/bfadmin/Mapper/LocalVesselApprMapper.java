 ...
 * @date 2023/5/10 15:25 update 优化查询未审核本地船舶
 */

@Mapper
public interface LocalVesselApprMapper {

    @Select("select count(*) from bfdata.bfdata_local_vessel_appr\n" +
            ...
            ");")
    int countLocalVesselApprInLast3Months(@Param("orgName") String orgName);
